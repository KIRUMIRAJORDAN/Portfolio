...
// 1. Move our main view code blocks into a separate component function
  ...
  return (
    <>
          ...
          <div className="md:col-span-1 order-1 md:order-2 flex justify-center">
            <div className="relative group w-48 h-48 sm:w-60 sm:h-60">
              ...
              <div className="relative w-full h-full bg-slate-900 border-2 border-slate-700/80 rounded-2xl overflow-hidden group-hover:border-blue-500 transition-colors duration-300">
                <img src={heroImage} alt="Jordan Kirumira Profile" className="w-full h-full object-cover group-hover:scale-105 transition duration-500 ease-out" />
      ...
      <section id="projects" className="mb-24">
        ...
        {/* Dynamic Filter Tab Control Bar */}
        ...
        {/* Project Display Grid mapping filtered array */}
        <div className="grid md:grid-cols-2 gap-6">
          {filteredProjects.map((project) => (
            <div key={project.id} className="bg-slate-900/60 border border-slate-800 rounded-xl p-6 hover:border-blue-500/40 transition-all duration-300 flex flex-col justify-between group">
              <div>
              ...
              <div className="mt-6">
                ...
                {/* ⚠️ UPGRADED ACTION: Changed simple anchor link to a React Router Link */}
                <Link 
      ...
      <section id="contact" className="bg-gradient-to-r from-slate-900 via-[#0f1b3a] to-slate-900 border border-slate-800 rounded-2xl p-8 text-center max-w-3xl mx-auto">
        ...
        <div className="mt-6">
          <a href="mailto:jordan@example.com" className="inline-block bg-white text-slate-950 font-semibold px-6 py-2.5 rounded-xl hover:bg-slate-200 transition-colors text-sm shadow-md">
            Get In Touch
          </a>
        </div>
      </section>
...
// 2. Main Parent Frame defining URL Routing Paths
